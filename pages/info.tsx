    ...
    <div className="page-container">
      <div className={styles.infoContainer}>
        <p className={styles.paragraph}>
          ...
          after purchasing. If you would like to be updated about new
          merchandise, please subscribe to our newsletter or follow{' '}
          <a
        ...
        <p className={styles.paragraph}>
          ...
          often found in a less-than-perfect state. Because many of the shirts
          we use are on their second life, some imperfections in the fabric are
          to be expected. We print by hand, which also means the graphic itself
          is subject to variation; each product is unique. Please refer to the
